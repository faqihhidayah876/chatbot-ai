...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        /* MARKDOWN + CODE HIGHLIGHTING + TOMBOL COPY */
        ...
        /* Container untuk code block dengan tombol copy */
        .markdown-body pre {
            position: relative;
        ...
        /* RESPONSIVE MOBILE - input lebih naik */
...
<body>
    ...
    <script>
        ...
        // ========== FUNGSI MENAMBAHKAN TOMBOL COPY KE SEMUA PRE ==========
        ...
        function typeWriter(element, markdownText, speed = 12) {
            ...
            function typing() {
                if (i < plainText.length) {
                    ...
                    // Tambahkan tombol copy setelah kode di-highlight
        ...
        // ========== TAMBAHKAN TOMBOL COPY UNTUK CHAT LAMA ==========
        addCopyButtonsToCodeBlocks();
        ...
        function appendMessage(role, text) {
            ...
            if(!isUser) {
                ...
                // Tambahkan tombol copy untuk pesan AI lama
                addCopyButtonsToCodeBlocks();
            }
        }

        // ========== APPEND LOADING (ANIMASI 3 TITIK) ==========
        ...
        // Jalankan highlight untuk semua blok kode yang sudah ada
